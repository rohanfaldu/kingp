...
import { createProduct, editProduct, getProductById, getAllProducts, deleteProduct, createPurchase, getPurchases, updatePurchaseStatus, getPurchasesByProduct, getAllProductPurchases } from '../../controllers/v1/product.controller';
