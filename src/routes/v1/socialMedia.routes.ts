...
import { createSocialMediaPlatform, editSocialMediaPlatform, getByIdeditSocialMediaPlatform, getSocialMediaPlatformsByUserId, getAllSocialMediaPlatform, deleteSocialMediaPlatform } from '../../controllers/v1/socialMedia.controller';
