...
import { createWorkPost, getWorkPosts, getWorkPostById, getAllWorkPosts, updateWorkPost, deleteWorkPost, applyForWorkPost, getWorkPostApplications } from '../controllers/workPost.controller';
